...
import com.wsj.cloud.service.PayService;
import com.wsj.cloud.util.BeanCopyUtil;
...
public class PayController {
    ...
    //${wsj.info}值是在consul服务器上注册的配置信息
    @GetMapping("/getInfo")
    public Result<String> getInfoByConsul(@Value("${wsj.info}") String info) {
        try {
